...
- (void)viewDidLoad
{
    ...
    DOMarqueeLabel *label1 = [[DOMarqueeLabel alloc] initWithText:@"This is a testing message!" scrollBehavior:DOMarqueeScrollNone frame:CGRectMake(10, 100, 300, 20)
                                                       customFont:[UIFont systemFontOfSize:15.0f] ScrollDuration:10.0 textColor:[UIColor greenColor]];
